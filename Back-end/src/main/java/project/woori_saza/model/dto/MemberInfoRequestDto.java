...
public class MemberInfoRequestDto {
    @ApiModelProperty(value = "파티원 선택 수량", example = "amount")
    private  Integer amount; //선택 수량
    @ApiModelProperty(value = "파티원 부담 금액", example = "price")
    private  Integer price; //파티원 부담 금액
    @ApiModelProperty(value = "파티 아이디", example = "partyId")
    private  Long partyId; //파티 아이디
    @ApiModelProperty(value = "프로필 아이디", example = "profileId")
