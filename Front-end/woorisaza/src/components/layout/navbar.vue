        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav class="ml-auto">
            ...
            <div v-if="accesstoken == null">
              <b-button
                pill
                style="background-color: #f1a501; border: 0"
                @click="$bvModal.show('signlogin')"
                >로그인 | 회원가입</b-button
              >
              &nbsp; &nbsp;
    ...
    <div>
      <div>
        <b-nav align="center">
          ...
          <b-nav-item router-link to="/board" :active="thisSazaActive" @click="getThisSazaActive"
            >이거사자</b-nav-item
          >
          <b-nav-item router-link :to="mysazaUrl" :active="mySazaActive" @click="getMySazaActive"
            >마이사자</b-nav-item
          >
          <b-nav-item router-link to="/guide" :active="guideActive" @click="getGuideActive"
            >가이드</b-nav-item
          >
        </b-nav>
      </div>
